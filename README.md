...
Todo o conteúdo de exemplo (nome da loja, textos, fotos, WhatsApp, Instagram, endereço) está em `data.js`, no objeto `CONTEUDO_PADRAO` — é só trocar pelos dados reais da loja, ou preencher direto pelo painel administrativo.
